...
2) Create a database in MySQL. Notice that while the syntax for \texttt{CREATE TABLE} is the same as Oracle, the data types are different. In particular, MySQL uses TINYINT, SMALLINT, etc. for integers.
